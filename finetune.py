...
LR_RATE_LIST2 = config["LR_RATE_LIST2"]

NUM_EPOCHS_LIST = config["NUM_EPOCHS_LIST"]
NUM_EPOCHS_LIST2 = config["NUM_EPOCHS_LIST2"]
...
def main():
    ...
    for lr_rate in LR_RATE_LIST2:
        for num_epoch in NUM_EPOCHS_LIST2:
            for augment in AUGMENT_LIST:
