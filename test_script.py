...
#     val_results = list(val_results_copy[val_sort_by])
#     val_models = list(val_results_copy["Model Name"])
#     greedy_model, best_ingredients = greedy_souping(lr_state_dicts, val_results, model_config["MODEL"], NUM_CLASSES, val_loader, train_loader, loss, DEVICE, CLASSIFICATION, val_sort_by, val_models = val_models)
#     greedy_model.to(DEVICE)
#     print(best_ingredients)
#     greedy_test_loss, greedy_test_acc, greedy_test_f1, greedy_test_recall, greedy_test_kappa, greedy_test_auc = val_step(greedy_model, test_loader, train_loader, loss, DEVICE, CLASSIFICATION)

#     test_results = list(results_test_df[test_sort_by])
#     test_models = list(sorted_test["Model Name"])
#     greedy_model_test, best_ingredients_test = greedy_souping(state_dicts, test_results, model_config["MODEL"], NUM_CLASSES, test_loader, train_loader, loss, DEVICE, CLASSIFICATION, test_sort_by, val_models=test_models)
